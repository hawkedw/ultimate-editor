...
import { dlog as ueDebugLog } from '../debug'
...
const dlog = (...a: any[]) => ueDebugLog('[UE][Batch][v4]', ...a)
...
const BatchEditPanel = ({
  ...
  const buildFeature = React.useCallback(() => {
    ...
    return g
  }, [aggregated, layer, uniqItems, policy])
...
const updates = uniqItems.map(it =>
  ...
  }, [canEdit, layer, uniqItems, editableFieldNames, onSaved, onCancel])
